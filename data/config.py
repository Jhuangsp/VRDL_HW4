...
VRDL_data = dataset_base.copy({
    'name': 'VRDL_data',

    'train_images': './data/VRDL_data/images/train_images',
    # 'train_info':   './data/VRDL_data/annotations/pascal_train.json',
    'train_info':   './data/VRDL_data/annotations/train_set.json',

    'valid_images': './data/VRDL_data/images/train_images',
    # 'valid_info':   './data/VRDL_data/annotations/pascal_train.json',
    'valid_info':   './data/VRDL_data/annotations/valid_set.json',
...
yolact_resnet50_pascal_config = yolact_resnet50_config.copy({
    ...
    # Dataset stuff
    'dataset': VRDL_data,
    'num_classes': len(VRDL_data.class_names) + 1,

    'max_iter': 8400*2,  # 120000
    'lr_steps': (4200*2, 7000*2),  # 60000, 100000
