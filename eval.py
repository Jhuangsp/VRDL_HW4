...
def evalimage(net: Yolact, path: str, save_path: str = None):
    ...
    img_numpy, VRDL_classes, VRDL_masks, VRDL_scores = prep_display(
        preds, frame, None, None, undo_transform=False, VRDL=True)
    print('Class')
...
def evalimages(net: Yolact, input_folder: str, output_folder: str):
    ...
    # path = str(p)
    for k in keys:
        path = './data/VRDL_data/images/test_images/' + \
            coco.imgs[k]['file_name']
